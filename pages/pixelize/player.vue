<template>
    ...
    >
        <div
            ...
            id="imgDiv"
        >
            <AppSpinningBall v-if="isLoading" />
        </div>

        <div
            class="flex flex-col-reverse w-10/12 gap-y-2 gap-x-2 items-center justify-center md:flex-row md:w-5/12 mt-5"
        >
            <PlayerAutoComplete
                class="w-full"
...
import { ComputedRef, computed, onMounted, ref } from "@nuxtjs/composition-api";
...
async function pixelize(attempts: ComputedRef<number>) {
    let c = document.createElement("canvas");
    let img1 = new Image();
    img1.src = photoToGuess.value.url;
